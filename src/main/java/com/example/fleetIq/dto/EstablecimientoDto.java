...
public class EstablecimientoDto {
    ...
    public EstablecimientoDto() {
        // Constructor vacío necesario para instanciación
    }
    ...
    public EstablecimientoDto(String id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }
    ...
    public Object getConfiguracionSla() {
    ...
    public void setConfiguracionSla(Object configuracionSla) {
        this.configuracionSla = configuracionSla;
    }
